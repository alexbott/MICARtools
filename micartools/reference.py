...
return_dataframe= Return the truncated, coding only table when running the function

ASSUMPTIONS:
Input file is a properly formatted GTF file
"""
def truncate_gtf(gtf_file, truncate=45, save_file=None, save_coding=None, return_dataframe=False):
...
Input file is a properly formatted GTF file
"""
def gene_dictionary(file, file_type='gtf', return_dictionary=True, save_file=None, gene_id=0, gene_name=2):
